...
# 设置filename
filename = f'model_{args.model}+pretrained_{args.pretrained}+fc_lr_{args.fc_learning_rate}+pretrained_lr_{args.pretrained_learning_rate}+momentum_{args.momentum}+augment_{args.augment}+weight_decay_{args.weight_decay}+dropout_{args.dropout_rate}+scheduler_{args.scheduler}+num_epochs_{args.num_epochs}'
